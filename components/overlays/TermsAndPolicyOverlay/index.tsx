...
const TermsAndPolicyOverlay = (props: Omit<OverlayProps, 'ariaLabel'>) => {
  ...
  const Content = (
    <>
      <CardLink color="on_primary" label="Terms of Use" href="/terms-of-use" className="mb-5" />
      <CardLink color="on_primary" label="Privacy Policy" href="/privacy-policy" className="mb-5" />
